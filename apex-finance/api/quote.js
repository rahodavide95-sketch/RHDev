...
export default async function handler(req) {
  ...
  // chart v8 with modules works on Vercel (same endpoint used for charts)
  const urls = [
    `https://query1.finance.yahoo.com/v8/finance/chart/${t}?range=1d&interval=1d&modules=${modules}`,
    `https://query2.finance.yahoo.com/v8/finance/chart/${t}?range=1d&interval=1d&modules=${modules}`,
