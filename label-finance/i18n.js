...
(function(){
  ...
  const DICT={
    it:{
      ...
      'r.preorder':'Preordine','r.order':"Data d'ordine *",'r.date':'Data','r.note':'Note','r.exclusive':'Esclusiva','r.exclusive_plat':'Piattaforma esclusiva','r.order_required':"Inserisci la data d'ordine (obbligatoria).",
    ...
    en:{
      ...
      'r.preorder':'Pre-order','r.order':'Order date *','r.date':'Date','r.note':'Notes','r.exclusive':'Exclusive','r.exclusive_plat':'Exclusive platform','r.order_required':'Enter the order date (required).',
