...
function buildContent() {
  ...
  const ICONS = {
    ...
    soundcloud: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.56 8.87V17h8.76c.98-.04 1.68-.74 1.68-1.68 0-.93-.76-1.68-1.68-1.68-.17 0-.31.03-.46.07-.17-1.94-1.76-3.47-3.74-3.47-.75 0-1.46.21-2.06.58-.07-.05-.14-.1-.21-.15.03-.17.05-.34.05-.52 0-1.66-1.35-3.01-3.01-3.01s-3.01 1.35-3.01 3.01c0 .05.01.1.01.15C6.88 11.59 6 12.59 6 13.81c0 1.37 1.1 2.5 2.5 2.5h3.06V8.87z"/><rect x=".5" y="14.5" width="1.25" height="2.5" rx=".625"/><rect x="2.25" y="13" width="1.25" height="4" rx=".625"/><rect x="4" y="12.5" width="1.25" height="4.5" rx=".625"/></svg>`,
