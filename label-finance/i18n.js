...
(function(){
  ...
  const DICT={
    it:{
      ...
      'con.tg_signed':'✓ Firmato','con.tg_rejected':'Rifiutato','con.tg_waiting':'In attesa di firma','con.tg_draft':'Bozza','con.tg_noemail':'Email mancante',
      ...
      // Chi siamo
      'about.title':'Chi siamo','about.subtitle':'Tutto il business della tua etichetta, in un solo posto.',
    ...
    en:{
      ...
      'con.tg_signed':'✓ Signed','con.tg_rejected':'Rejected','con.tg_waiting':'Awaiting signature','con.tg_draft':'Draft','con.tg_noemail':'Email missing',
      ...
      'about.title':'About','about.subtitle':'Your label’s entire business, in one place.',
      ...
      'about.p1':`Label Finance was born from a passion: giving <strong>independent labels</strong> the same superpowers as the majors, without their complexity. From <strong>royalties</strong> to <strong>signed contracts</strong>, from <strong>merch</strong> to the <strong>AI assistant</strong>, all the way to ready-to-send statements: every number in its place, every artist paid to the cent. Built with care, for people who put the music first. 🎧`,
