...
(function(){
  ...
  const DICT={
    it:{
      ...
      'cimp.preview':'{rows} righe → {rel} nuove release, {art} nuovi artisti ({dup} già presenti)','cimp.done':'Importate {rel} release e {art} artisti ({dup} doppioni saltati) ✓','cimp.empty':'File vuoto o non leggibile.',
    ...
    en:{
      ...
      'cimp.preview':'{rows} rows → {rel} new releases, {art} new artists ({dup} already present)','cimp.done':'Imported {rel} releases and {art} artists ({dup} duplicates skipped) ✓','cimp.empty':'Empty or unreadable file.',
