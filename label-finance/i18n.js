...
'cons.sub':"Tutte le tue etichette in un colpo d'occhio",'cons.byLabel':'Per etichetta','cons.hint':"Clicca una riga per aprire quell'etichetta",'cons.h_label':'Etichetta','cons.h_rel':'Release','cons.h_art':'Artisti','cons.best':'★ migliore','cons.label1':'etichetta','cons.labelN':'etichette',
      ...
      'notif.title':'Notifiche','notif.task_t':'Promemoria','notif.task_over':'Promemoria scaduto','notif.task_due':'Promemoria','notif.read_all':'Segna tutte lette','notif.clear':'Svuota','notif.empty':'Nessuna notifica.','notif.mark_read':'Segna come letta','notif.mark_unread':'Segna come da leggere',
...
'cons.sub':'All your labels at a glance','cons.byLabel':'By label','cons.hint':'Click a row to open that label','cons.h_label':'Label','cons.h_rel':'Releases','cons.h_art':'Artists','cons.best':'★ best','cons.label1':'label','cons.labelN':'labels',
      ...
      'notif.title':'Notifications','notif.task_t':'Reminder','notif.task_over':'Reminder overdue','notif.task_due':'Reminder','notif.read_all':'Mark all read','notif.clear':'Clear all','notif.empty':'No notifications.','notif.mark_read':'Mark as read','notif.mark_unread':'Mark as unread',
