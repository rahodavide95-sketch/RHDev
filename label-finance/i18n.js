...
(function(){
  ...
  const DICT={
    it:{
      ...
      'con.generate':'⚙ Genera contratto','con.preview':'Anteprima contratto','con.print':'⤓ Stampa / PDF','con.send':'✉ Invia per firma',
      ...
      'con.status':'Stato','con.st_sent':'Inviato','con.st_draft':'Bozza','con.st_signed':'Firmato','con.open':'Apri',
    ...
    en:{
      ...
      'con.generate':'⚙ Generate contract','con.preview':'Contract preview','con.print':'⤓ Print / PDF','con.send':'✉ Send for signature',
      'con.sign_now':'✍ Sign now','con.back':'‹ Edit','con.saved':'Saved contracts','con.empty':'No contracts yet. Create one with “New contract”.',
      'con.status':'Status','con.st_sent':'Sent','con.st_draft':'Draft','con.st_signed':'Signed','con.open':'Open',
